...
class AnimationRenderer:
    ...
    def render_animation(self, animation: AnsciAnimation, quality: str = "high") -> List[str]:
        ...
        print(f"🎬 Animation rendering complete: {len(video_paths)}/{len(animation.blocks)} scenes successful")
        return video_paths
    
    def render_scene_block(self, scene_block: AnsciSceneBlock, scene_name: str, quality: str = "high") -> Optional[str]:
        """
    ...
    def combine_videos(self, video_paths: List[str], output_name: str = "complete_animation") -> str:
        """
...
def render_animation(animation: AnsciAnimation, output_dir: str = None, quality: str = "high", enable_validation: bool = True) -> List[str]:
    """
...
def render_complete_animation(animation: AnsciAnimation, output_name: str = "complete_animation", output_dir: str = None, enable_validation: bool = True) -> str:
    """
